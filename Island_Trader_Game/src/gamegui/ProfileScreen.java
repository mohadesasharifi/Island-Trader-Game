...
public class ProfileScreen extends Screen{
	...
	protected void initialize(Container container) {
		...
		lblDaysLabel.setBounds(636, 0, 113, 16);
		...
		lblCurrentIslandLabel.setBounds(386, 26, 101, 16);
		...
		btnPurchaseCoins.setBounds(664, 50, 126, 21);
		...
		btnMainMenu.setBounds(41, 481, 106, 21);
