...
//		}
		...
		ArrayList myRoute0 = new ArrayList<Integer>();
		for (int i: route0) {
			myRoute0.add(i);
		}
		...
		ArrayList myRoute1 = new ArrayList<Integer>();
		for (int i: route1) {
			myRoute1.add(i);
		}
		...
		ArrayList myRoute2 = new ArrayList<Integer>();
		for (int i: route2) {
			myRoute2.add(i);
		}
		...
		ArrayList myRoute3 = new ArrayList<Integer>();
		for (int i: route3) {
			myRoute3.add(i);
		}
		...
		ArrayList myRoute4 = new ArrayList<Integer>();
		for (int i: route4) {
			myRoute4.add(i);
		}
		...
		ArrayList myRoute5 = new ArrayList<Integer>();
		for (int i: route5) {
			myRoute5.add(i);
		}
		...
		ArrayList myRoute6 = new ArrayList<Integer>();
		for (int i: route6) {
			myRoute6.add(i);
		}
		...
		ArrayList myRoute7 = new ArrayList<Integer>();
		for (int i: route7) {
			myRoute7.add(i);
		}
		...
		ArrayList myRoute8 = new ArrayList<Integer>();
		for (int i: route8) {
			myRoute8.add(i);
		}
		...
		ArrayList myRoute9 = new ArrayList<Integer>();
		for (int i: route9) {
			myRoute9.add(i);
		}
		...
		ArrayList myRoute10 = new ArrayList<Integer>();
		for (int i: route10) {
			myRoute10.add(i);
		}
